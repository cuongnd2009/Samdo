...
(function( $, window, document, undefined ) {
	...
	var DataTable = function ( options )
	{
		 ...
		 *      <li>object - data object when using <i>mData</em></li>
		 *      <li>array of objects - multiple data objects when using <i>mData</em></li>
		 *    </ul>
		 *  @param {bool} [redraw=true] redraw the table or not
		 *  @returns {array} An array of integers, representing the list of indexes in
		 *    <i>aoData</em> ({@link DataTable.models.oSettings}) that have been added to
		 *    the table.
		 *  @dtopt API
		 *  @deprecated Since v1.10
		 *
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			 ...
			 *  @type string
			 *  @default <i>Empty string - i.e. disabled</em>
			 *
			 *  @dtopt Language
		 ...
		 *   </ul>
		 *  @type string
		 *  @default lfrtip <i>(when `jQueryUI` is false)</em> <b>or</b>
		 *    <"H"lfr>t<"F"ip> <i>(when `jQueryUI` is true)</em>
		 *
		 *  @dtopt Options
		 ...
		 * is recommended.
		 *  @type boolean|string
		 *  @default <i>blank string - i.e. disabled</em>
		 *
		 *  @dtopt Features
	...
	DataTable.defaults.column = {
		 ...
		 * two columns.
		 *  @type array|int
		 *  @default null <i>Takes the value of the column index automatically</em>
		 *
		 ...
		 *  @default null <i>Use automatically calculated column index</em>
		 *
		 ...
		 * through plug-ins.
		 *  @type string
		 *  @default null <i>Auto-detected from raw data</em>
		 *
	...
	DataTable.ext = _ext = {
		...
		type: {
			 ...
			 * for that target column. This is the corollary of <i>afnSortData</em>
			 * for searching data.
			 *
...
$.extend(true, $.fn.dataTable.defaults, {
	...
	*/
	...
	language: {
		...
		paginate: {
			previous: "<em class='fal fa-chevron-left'></em>",
			next: "<em class='fal fa-chevron-right'></em>"
		},
		...
		search: '<div class="input-group-text d-inline-flex width-3 align-items-center justify-content-center border-bottom-right-radius-0 border-top-right-radius-0 border-right-0"><em class="fal fa-search"></em></div>',
		/* add search filter */
...
AutoFill.actions = {
	...
	fill: {
		...
		option: function ( dt, cells ) {
			return dt.i18n('autoFill.fill', 'Fill all cells with <i>'+cells[0][0].label+'</em>' );
		},
...
DataTable.ext.buttons.copyHtml5 = {
	...
	action: function ( e, dt, button, config ) {
		...
		var message = $('<span>'+dt.i18n( 'buttons.copyKeys',
				'Press <i>ctrl</em> or <i>\u2318</em> + <i>C</em> to copy the table data<br>to your system clipboard.<br><br>'+
		...
		altEditor.prototype,
		{
			...
			_setup: function () {
				...
				var modal = '<div class="modal fade" id="' + modal_id + '" tabindex="-1" role="dialog">' +
					...
					'<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><em class="fal fa-times"></em></span></button>' +
					'</div>' +
					'<div class="modal-body">' +
					'<p></p>' +
					'</div>' +
			...
			_openDeleteModal: function () {
				...
				$(selector).on('show.bs.modal', function () {
					var btns = '<button type="button" data-content="remove" class="btn btn-default" data-dismiss="modal">Cancel</button>' +
						'<button type="button"  data-content="remove" class="btn btn-danger" id="deleteRowBtn"><em class="fal fa-times"></em> Delete</button>';
